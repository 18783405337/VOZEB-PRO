...
const POSTGRES_SCHEMA_OBJECTS = [
    ...
    "tenants_slug_lower_idx",
    "tenant_domains_hostname_lower_idx",
    "tenant_roles_tenant_id_id_key",
    "tenant_role_permissions_tenant_role_fkey",
    "tenant_members_tenant_role_fkey",
    ...
    "tenant_domains_set_updated_at",
    "tenant_roles_set_updated_at",
    "tenant_members_set_updated_at",
