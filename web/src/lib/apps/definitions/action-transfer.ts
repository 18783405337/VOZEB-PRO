...
export const actionTransfer: AppDefinition = {
    ...
    inputSchema: [
        { key: "referenceImages", kind: "images", label: "人物参考图", required: true, maxItems: 3 },
        ...
        { key: "mode", kind: "select", label: "生成模式", required: true, options: ["fast", "standard", "max"] },
        { key: "faceCount", kind: "number", label: "人物数量", required: false, min: 1, max: 7 },
