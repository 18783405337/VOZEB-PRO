...
export const adminSections: AdminSection[] = [
    ...
    { key: "tenants", label: "租户管理", description: "管理平台租户的创建、状态和基础信息。", shortDescription: "租户与空间", icon: <Building2 className="size-4" /> },
...
export const adminSectionGroups: AdminSectionGroup[] = [
    ...
    { title: "系统管理", items: sectionsFor(["tenants", "site", "settings", "accountDeletion"]) },
